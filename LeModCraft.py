...
import os, json, socket, subprocess, re, shutil, sys
...
sys.path.append(os.path.join(os.path.dirname(__file__), "recources", "homepage"))
from homepage import build_home_page
from recources.Versions.view_edit import create_Versions_tab
...
class Launcher(tk.Tk):
    ...
    def build_pages(self):
        self.pages["Home"] = lambda: build_home_page(self, BG, FG, CARD, ACCENT)
        self.pages["Versions"] = lambda: create_Versions_tab(self.page_frame)
